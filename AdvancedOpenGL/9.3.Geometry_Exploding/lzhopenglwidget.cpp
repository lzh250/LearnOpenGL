...
void LzhOpenGLWidget::initializeGL()
{
    ...
    our_shader.Init(":/shader/1.model_loading.vs", ":/shader/1.model_loading.fs", ":/shader/9.3.geometry_shader.gs");
...
void LzhOpenGLWidget::paintGL()
{
    ...
    float a  = static_cast<float>((unsigned short)QDateTime::currentMSecsSinceEpoch() / 360.0 * 3.14159265358979);
    //qDebug() << a;
    QMatrix4x4 view = LookAt(cam_pos, cam_pos + cam_front, cam_up);
    our_shader.Use();
    our_shader.SetMat4("view", view);
    //our_shader.SetFloat("time", static_cast<float>((unsigned short)QDateTime::currentMSecsSinceEpoch() / 360.0 * 3.14159265358979));
    our_shader.SetFloat("time", a);
