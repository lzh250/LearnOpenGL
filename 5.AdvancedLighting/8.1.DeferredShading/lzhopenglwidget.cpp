...
void LzhOpenGLWidget::initializeGL()
{
    ...
    shader_geometry_pass.Init(":/shader/8.1.g_buffer.vs", ":/shader/8.1.g_buffer.fs");
    ...
    object_positions.push_back(QVector3D( 0.0,  -0.5, -3.0));
    object_positions.push_back(QVector3D( 3.0,  -0.5, -3.0));
    object_positions.push_back(QVector3D(-3.0,  -0.5,  0.0));
    object_positions.push_back(QVector3D( 0.0,  -0.5,  0.0));
    object_positions.push_back(QVector3D( 3.0,  -0.5,  0.0));
    object_positions.push_back(QVector3D(-3.0,  -0.5,  3.0));
    object_positions.push_back(QVector3D( 0.0,  -0.5,  3.0));
    object_positions.push_back(QVector3D( 3.0,  -0.5,  3.0));
    ...
    glTextureParameteri(g_albedo_spec, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTextureParameteri(g_albedo_spec, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
...
void LzhOpenGLWidget::paintGL()
{
    ...
    {
        model.setToIdentity();
        model.translate(object_positions[i]);
        model.scale(0.5f);
