...
void LzhOpenGLWidget::initializeGL()
{
    ...
    diffuse_mapping = LoadTexture(":/res/brickwall.jpg");
    normal_mapping  = LoadTexture(":/res/brickwall_normal.jpg");
...
void LzhOpenGLWidget::paintGL()
{
    ...
    QMatrix4x4 model;
    model.rotate((unsigned short)QDateTime::currentMSecsSinceEpoch() * -10, QVector3D(1.0f, 0.0f, 1.0f));
